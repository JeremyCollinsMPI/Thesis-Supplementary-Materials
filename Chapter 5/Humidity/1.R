...
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.8))
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.7))
number=4
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.5))
number=5
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.50))
number=6
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.1))
number=7
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
number=8
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
number=9
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
number=10
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
number=11
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
...
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.8))
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.6))
number=4
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.6))
number=5
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.5))
...
number=9
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
epicentersdata[,7][epicentersdata[,6]==2]

MAP OF PAPUA
epicentersdata=read.csv("~/Documents/Epicentres/epicenterspapua.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(120,160), ylim=c(-15,5))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.75))
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.6))
number=4
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.45))
number=5
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
number=6
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
...
MAP OF EUROPE
epicentersdata=read.csv("~/Documents/Epicentres/epicenterseurope.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-10,60), ylim=c(35,65))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
...
epicentersdata=read.csv("~/Documents/Epicentres/epicenterseurope.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-10,80), ylim=c(20,65))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.4))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
...
PLOSIVES IN EURASIA
epicentersdata=read.csv("~/Documents/Epicentres/epicenterseuropeplosives.txt",header=F,stringsAsFactors=F,sep='\t')
map("world",xlim=c(-10,90), ylim=c(20,75))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.95))
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.9))
number=4
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.85))
number=5
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.8))
number=6
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.8))
...
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
number=24
points(epicentersdata[,3][epicentersdata[,6]>number-1],epicentersdata[,2][epicentersdata[,6]>number-1],pch=16,col='red')

IN ORDER OF ANIMATION
epicentersdata=read.csv("~/Documents/Epicentres/epicenterseuropeplosives.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-10,70), ylim=c(20,65))
number=24
points(epicentersdata[,3][epicentersdata[,6]>number-1],epicentersdata[,2][epicentersdata[,6]>number-1],pch=16,col='red')
number=23
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
...
map("worldHires",xlim=c(-130,-70), ylim=c(-10,55))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.5))
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
...
SMALLER MAP OF MEXICO
epicentersdata=read.csv("~/Documents/Epicentres/epicentersmexico.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-120,-70), ylim=c(-10,30))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.5))
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
...
number=10
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='red')
epicentersdata[,7][epicentersdata[,6]==4]

MAP OF SOUTH AMERICA
epicentersdata=read.csv("~/Documents/Epicentres/epicenterssouthamerica.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-85,-35), ylim=c(-55,20))
number=2
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.6))
number=3
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col=gray(0.2))
number=4
points(epicentersdata[,3][epicentersdata[,6]==number],epicentersdata[,2][epicentersdata[,6]==number],pch=16,col='blue')
number=8
family='Chibchan'
points(epicentersdata[,3][epicentersdata[,7]==family],epicentersdata[,2][epicentersdata[,7]==family],pch=16,col='red')
epicentersdata[,7][epicentersdata[,6]>4]
drawcurve(1)

EUROPE GENDERS
epicentersdata=read.csv("~/Documents/Epicentres/genders.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-10,120), ylim=c(20,65))
number=2
points(epicentersdata[,6][epicentersdata[,3]==number],epicentersdata[,5][epicentersdata[,3]==number],pch=16,col=gray(0.6))
number=3
points(epicentersdata[,6][epicentersdata[,3]==number],epicentersdata[,5][epicentersdata[,3]==number],pch=16,col=gray(0.1))
number=4
points(epicentersdata[,6][epicentersdata[,3]==number],epicentersdata[,5][epicentersdata[,3]==number],pch=16,col='blue')
number=5
points(epicentersdata[,6][epicentersdata[,3]==number],epicentersdata[,5][epicentersdata[,3]==number],pch=16,col='red')


EUROPE CASES
epicentersdata=read.csv("~/Documents/Epicentres/cases.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-10,85), ylim=c(20,65))
number=2
points(epicentersdata[,6][epicentersdata[,3]==number],epicentersdata[,5][epicentersdata[,3]==number],pch=16,col=gray(0.6))
number=3
points(epicentersdata[,6][epicentersdata[,3]==number],epicentersdata[,5][epicentersdata[,3]==number],pch=16,col=gray(0.6))
...
TESTING DISTANCE FROM TURKEY 
AGAINST CASES
distancefromturkey=function(x){
  return(distHaversine(c(lats[x],longs[x]),c(39,35)))
}
epicentersdata=read.csv("~/Documents/Epicentres/genders.txt",header=F,stringsAsFactors=F,sep='\t')
longs=epicentersdata[,6][epicentersdata[,8]=='Indo-European']
lats=epicentersdata[,5][epicentersdata[,8]=='Indo-European']
feature=epicentersdata[,3][epicentersdata[,8]=='Indo-European']
a=sapply(1:length(lats),distancefromturkey)
summary(lm(a~feature))
cor.test(a,feature,method='spearman')
...
function(min,colour,frame,lat,long,value){
  testpts=structure(list(x=frame[,long][frame[,value]>min],y=frame[,lat][frame[,value]>min]))
  points(testpts,col='black',pch=16,cex=0.5)
  chuld <- lapply(testpts,"[",chull(testpts))
  polygon(chuld,lty=2,border=colour)
  polygon(spline.poly(as.matrix(as.data.frame(chuld)),100),border=colour,lwd=2,col=colour)
  points(frame[,long],frame[,lat],col='black',pch=16,cex=0.5)
  areaPolygonkm(spline.poly(as.matrix(as.data.frame(chuld)),100))  
}
...
points(epicentersdata[,3][epicentersdata[,6]==max],epicentersdata[,2][epicentersdata[,6]==max],pch=16,col='red')
...
epicentersdata[epicentersdata[,6]==9,]  
map("worldHires",xlim=c(70,130), ylim=c(6,50))
min=1
max=7
for (n in (min:max)){
...
#origin of rice above hainan according to nature paper
...
PAPUA PLOSIVES
epicentersdata=read.csv("~/Documents/Epicentres/epicenterspapuaplosives.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(120,160), ylim=c(-15,5))
min=9
max=16
for (n in (min:max)){
...
drawcurve(2,heat.colors(4,alpha=0.6)[2])
drawcurve(3,heat.colors(4,alpha=0.7)[4])

#or more restricted
long=c(-85,-35)
lat=c(-30,20)
map("worldHires",xlim=long,ylim=lat)
...
drawcurve(3,heat.colors(4,alpha=0.7)[4])
epicentersdata=read.csv("~/Documents/Epicentres/epicenterssouthamerica.txt",header=F,stringsAsFactors=F,sep='\t')
points(epicentersdata[,3][epicentersdata[,6]==2],epicentersdata[,2][epicentersdata[,6]==2],pch=1,col='black')
...
SOUTH AMERICA PLOSIVES
epicentersdata=read.csv("~/Documents/Epicentres/epicenterssouthamericaplosives.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-85,-35), ylim=c(-55,20))
min=12
max=17
for (n in (min:max)){
...
NORTH AMERICA PLOSIVES
epicentersdata=read.csv("~/Documents/Epicentres/epicentersnorthamericaplosives.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-140,-70), ylim=c(0,65))
min=11
max=26
for (n in (min:max)){
  drawcurve(n,heat.colors(max-min,alpha=0.2)[n-min+1])
...
AUSTRALIA PLOSIVES
epicentersdata=read.csv("~/Documents/Epicentres/epicentersaustraliaplosives.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(110,155), ylim=c(-50,-11))
min=11
max=13
for (n in (min:max)){
  drawcurve(n,heat.colors(max-min,alpha=0.2)[n-min+1])
...
significances
MEXICO PLOSIVES
epicentersdata=read.csv("~/Documents/Epicentres/epicentersmexicoplosives.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-120,-70), ylim=c(-10,35))
min=7
max=16
for (n in (min:max)){
  drawcurve(n,heat.colors(max-min,alpha=0.6)[n-min+1])
}
drawcurve(16,'blue')
WORLD
epicentersdata=read.csv("~/Documents/Epicentres/epicentersworld.txt",header=F,stringsAsFactors=F,sep='\t')
epicentersdata=epicentersdata[epicentersdata[,9]=='Africa',]
...
r1a=read.table('/Users/jercol/Documents/Epicentres/R1a.txt',header=F)
r1a$ratio=r1a$RM558/r1a$N
r1a$ratio=r1a$R1a/r1a$N
summary(lm(r1a$Coda~r1a$ratio))
r1a=r1a[!is.na(r1a$Coda),]
r1a$Coda
r1a
...
epicentersdata=epicentersdata[epicentersdata[,2]>lat[1],]
epicentersdata=epicentersdata[epicentersdata[,2]<lat[2],]
epicentersdata=epicentersdata[epicentersdata[,7]=='Indo-European',]
ASIA
epicentersdata=read.csv("~/Documents/Epicentres/epicentersasia.txt",header=F,stringsAsFactors=F,sep='\t')
origin=c(109,25.84)
...
min=2
max=6
origin=c(-66.25,-11.33)
origin=c(-72,0)
#most tones
origin=c(-68,-3.5)
which(epicentersdata[,6]==8)
epicentersdata[104,]
...
#epicentersdata$fromorigin=log(epicentersdata$fromorigin,100)
#plot(sapply(min:max,findmedian))
#summary(lm(min:max~sapply(min:max,findmedian)))
#summary(lm(epicentersdata[,6]~epicentersdata$fromorigin))
...
pcor.test(epicentersdata[,6],epicentersdata$humidityvalues,epicentersdata$fromorigin,method='spearman')
summary(lm(epicentersdata[,6]~epicentersdata$humidityvalues+epicentersdata$fromorigin))

#correlations with population size
populationvalues=sapply(epicentersdata[,8],population,simplify='vector')
summary(lm(epicentersdata[,6]~populationvalues))
...
CORRELATIONS WITH AGRICULTURE

AFRICA
epicentersdata=read.csv("~/Documents/Epicentres/epicentersafrica.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-20,60), ylim=c(-40,40))
points(epicentersdata[,3][epicentersdata$agri==2],epicentersdata[,2][epicentersdata$agri==2],col='red')
points(epicentersdata[,3][epicentersdata$agri==3],epicentersdata[,2][epicentersdata$agri==3],col='blue')
points(50,10,col='green')
place1=c(c(-18,13),c(-18,4),c(5,4),c(5,13),1)
place1=c(-18,5,4,13,1)
place2=c(5,14,4,10,2)
place3=c(14,50,-12,10,3)
place4=c(14,50,-40,-12,4)
places=data.frame(place1,place2,place3,place4)
places=t(places)

places[1,2]
within=function(x,place){  
  response=0
  if (epicentersdata[x,3]>place[1]){
    if (epicentersdata[x,3]<place[2]){
      if (epicentersdata[x,2]>place[3]){
        if(epicentersdata[x,2]<place[4]){
          response=1
        }
      }
    }
...
agri=function(x){
  response=max(places[,5]+1)
  for(n in 1:length(places[,1])){
    if(within(x,places[n,])){
      response=places[n,5]
    }
  }
  return(response)
}
epicentersdata$agri=sapply(1:length(epicentersdata[,6]),agri)
summary(lm(epicentersdata$agri~epicentersdata[,6]))
rank=5
points(epicentersdata[,3][epicentersdata$agri==rank],epicentersdata[,2][epicentersdata$agri==rank])

binarise=function(x,y,z){
  output=c()
  for (member in x){
...
multiwithin=sapply(1:length(epicentersdata[,6]),within,places[2,])
multiwithin=multiwithin+sapply(1:length(epicentersdata[,6]),within,places[1,])
multiwithin=multiwithin+sapply(1:length(epicentersdata[,6]),within,places[2,])
summary(glm(sapply(epicentersdata[,6],binarise,6,15)~multiwithin))
...
set=function(x){
  if(x=='africa'){
    return(read.csv("~/Documents/Epicentres/epicentersafrica.txt",header=F,stringsAsFactors=F,sep='\t'))
  }
  if(x=='asia'){
    return(read.csv("~/Documents/Epicentres/epicentersasia.txt",header=F,stringsAsFactors=F,sep='\t'))
  }
  if(x=='mexico'){
    return(read.csv("~/Documents/Epicentres/epicentersmexico.txt",header=F,stringsAsFactors=F,sep='\t'))
  }
  if (x=='newguinea'){
    epicentersdata=read.csv("~/Documents/Epicentres/epicentersworld.txt",header=F,stringsAsFactors=F,sep='\t')
    map("world",xlim=c(128,160), ylim=c(-10.3,5))
    long=c(128,160)
    lat=c(-10.3,5)
    epicentersdata=epicentersdata[epicentersdata[,3]<long[2],]
    epicentersdata=epicentersdata[epicentersdata[,3]>long[1],]
    epicentersdata=epicentersdata[epicentersdata[,2]>lat[1],]
    epicentersdata=epicentersdata[epicentersdata[,2]<lat[2],]
    return(epicentersdata)
  }
}
epicentersdata=read.csv("~/Documents/Epicentres/epicentersafrica.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-20,60), ylim=c(-40,40))
drawcurvearoundfamily('Niger-Kongo','blue')
drawcurve(2,'blue')

ASIA
epicentersdata=read.csv("~/Documents/Epicentres/epicentersasia.txt",header=F,stringsAsFactors=F,sep='\t')
map("world",xlim=c(70,150), ylim=c(-9,50))
drawcurvearoundfamily('Tibeto-Burman','blue')
drawcurve(1,'blue')
which(epicentersdata[,2]==min(epicentersdata[,2]))
MEXICO
epicentersdata=read.csv("~/Documents/Epicentres/epicentersmexico.txt",header=F,stringsAsFactors=F,sep='\t')
map("worldHires",xlim=c(-120,-70), ylim=c(-10,40))
drawcurvearoundfamily('Otomanguean','blue')
drawcurve(1,'blue')


CORRELATIONS WITH HUMIDITY
require(gdata)
climateiso=read.csv('/Users/jercol/Documents/Epicentres/humidityiso.csv',stringsAsFactors=F)
climate=read.csv('/Users/jercol/Documents/Epicentres/humidity.csv',stringsAsFactors=F)
...
population=function(x){
  return(climateiso$Population[which(climateiso$ISO.code==x)][1])
}
population('goa')

populationdata=read.csv('/Users/jercol/Documents/Epicentres/population.txt',stringsAsFactors=F,header=F,sep='\t')
populationdata=populationdata[c(2,5,7,8,23)]
populationdata=populationdata[populationdata[,1] %in% epicentersdata[,8],]
populationdata[,5]=as.numeric(gsub(',','',populationdata[,5]))
populationdata=populationdata[!is.na(populationdata[,5]),]
#correlations with population size
cor.test(populationdata[,2],populationdata[,5],method='pearson')

SOUTH AMERICA EVIDENTIALITY

visual=read.table('/Users/jercol/Documents/Epicentres/South America/visual',header=T,stringsAsFactors=F)
assumed=read.table('/Users/jercol/Documents/Epicentres/South America/assumed',header=T,stringsAsFactors=F)
inferred=read.table('/Users/jercol/Documents/Epicentres/South America/inferred',header=T,stringsAsFactors=F)
firsthand=read.table('/Users/jercol/Documents/Epicentres/South America/firsthand',header=T,stringsAsFactors=F)
secondhand=read.table('/Users/jercol/Documents/Epicentres/South America/secondhand',header=T,stringsAsFactors=F)

combined=cbind(visual,assumed=assumed$value,inferred=inferred$value,firsthand=firsthand$value,secondhand=secondhand$value)
combined$visual=combined$value
combined=combined[!combined$assumed=='?',]
combined=combined[!combined$inferred=='?',]
combined=combined[!combined$visual=='?',]
combined=combined[!combined$firsthand=='?',]
combined=combined[!combined$secondhand=='?',]
score=function(x){
  total=0
  if(!combined$assumed[x]=='N'){
    total=total+1
  }
  if(!combined$inferred[x]=='N'){
    total=total+1
  }
  if(!combined$visual[x]=='N'){
    total=total+1
  } 
  if(!combined$firsthand[x]=='N'){
    total=total+1
  }   
  if(!combined$secondhand[x]=='N'){
    total=total+1
  }   
  return(total)    
      
}
combined$scores=sapply(1:length(combined[,1]),score)

map("worldHires",xlim=c(-85,-35), ylim=c(-55,20))


generaldrawcurve(0,heat.colors(4)[1],combined,5,6,13)
generaldrawcurve(1,heat.colors(4)[2],combined,5,6,13)
generaldrawcurve(2,heat.colors(4)[3],combined,5,6,13)
generaldrawcurve(3,heat.colors(4)[4],combined,5,6,13)

combined=combined[combined$scores>0,]
origin=c(-72,0)
generaldistancefromorigin=function(x,y,z,frame,lat,long){
  return(distHaversine(c(frame[x,long],frame[x,lat]),c(y,z)))
}
fromorigin=c()
for (n in 1:length(combined[,6])){
  fromorigin=append(fromorigin,generaldistancefromorigin(n,origin[1],origin[2],combined,5,6))
}
combined$fromorigin=fromorigin
#plot(sapply(min:max,findmedian))
#summary(lm(min:max~sapply(min:max,findmedian)))
#summary(lm(epicentersdata[,6]~epicentersdata$fromorigin))
cor.test(combined$scores,combined$fromorigin,method='pearson')
combined$scores
head(combined)
combined$family[combined$scores==2]
points(-62,-12)
...
#random starting point and random initial value for tones
#pick a few languages within a certain radius and assign them value-1
#repeat
#instead of within a certain radius, could choose within same genus (at a certain level: higher level analogous to greeater distance)
#also have a model which occasionally allows languages to increase tones as well, e.g. one language per 5 iterations
#also have a model which makes number of tones drop at a certain rate
#the statistics:
#correlation of tones with distance from point with highest tones
#size of areas which surround decreasing numbers of tones
#measures of phylogenetic signal
#number of languages which have different numbers of tones: should increase slowly as numbers of tones decreases

#things to do;
#have phlyogenetic distance as well as geographic

epicentersdata[,11]=epicentersdata[,6]
...
fromlang=function(x){
  distHaversine(epicentersdata[x,c(3,2)],epicentersdata[lang,c(3,2)])/1000
}
...
for (member in 1:length(epicentersdata[,6])){
  if(epicentersdata[member,13]<1681){
...
#  lang2=sample(which(epicentersdata[,13]<radius1),1)
...
quickpoints(epicentersdata,2,3,14,1)
quickpoints(epicentersdata,2,3,12,3)
quickpoints(epicentersdata,2,3,12,max(epicentersdata[,12]))
quickpoints(epicentersdata,2,3,8,epicentersdata[lang,8])
generaldrawcurve(4,'red',epicentersdata,2,3,12)
...
noise=1000
list=sample(1:length(epicentersdata[,6]),noise,replace=T)
for (member in list){
  epicentersdata$fake[member]=epicentersdata$fake[member]+1
}
#map("world",xlim=c(-20,60), ylim=c(-40,40))
map("world",xlim=c(70,150), ylim=c(-9,50))
#map("world",xlim=c(-120,-70), ylim=c(-10,40))
for (n in min(epicentersdata$fake):max(epicentersdata$fake)){
  generaldrawcurve(n,heat.colors(max(epicentersdata$fake)-min(epicentersdata$fake),alpha=0.4)[n-min(epicentersdata$fake)+1],epicentersdata,2,3,which(colnames(epicentersdata)=='fake'))
}
generaldrawcurve(max(epicentersdata$fake)-2,'red',epicentersdata,2,3,which(colnames(epicentersdata)=='fake'))
#modifying genera
...
pickrandomnode(newtree,2)
isancestor(newtree,'Afro-Asiatic','Berber')
epicentersdata$fake=epicentersdata[,6]
noiseadd=15
noiselose=0
distancesoff=c()
...
africadistancesoff=distancesoff
africatonesoff=tonesoff
asiadistancesoff=distancesoff
asiatonesoff=tonesoff
asiacontactdistancesoff=distancesoff
asiacontacttonesoff=tonesoff
mexicodistancesoff
makemap(3)
#map("world",xlim=c(-20,60), ylim=c(-40,40))
map("world",xlim=c(70,150), ylim=c(-9,50))
...
points(epicentersdata[,3][epicentersdata$fake==max(epicentersdata$fake)],epicentersdata[,2][epicentersdata$fake==max(epicentersdata$fake)])

distanceoff=1300
epicentersdata[,12]=sapply(1:length(epicentersdata[,6]),fromlang)
epicentersdata[,13]=rep(0,length(epicentersdata[,6]))
for (member in 1:length(epicentersdata[,6])){
  if(epicentersdata[member,12]<mean(distancesoff)){
    epicentersdata[member,13]=1
  }
}
makemap(2)
quickpoints(epicentersdata,2,3,13,1)
drawcurve(max(epicentersdata[,6])-8,'red')
